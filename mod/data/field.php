...
if (($mode == 'new') && (!empty($newtype)) && confirm_sesskey()) {          ///  Adding a new field
    ...
    echo $OUTPUT->single_select(new moodle_url($popupurl), 'newtype', $menufield, null, array(''=>'choosedots'), 'fieldform', array('label' => get_string('newfield','data').$OUTPUT->help_icon('newfield', 'data')));
    echo '</div>';
