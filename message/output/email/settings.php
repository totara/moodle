...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('noreplyaddress', get_string('noreplyaddress', 'message_email'), get_string('confignoreplyaddress', 'message_email'), 'noreply@' . $wwwroot->get_host(), PARAM_NOTAGS));
