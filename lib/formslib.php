...
class MoodleQuickForm_Renderer extends HTML_QuickForm_Renderer_Tableless{
    ...
    function MoodleQuickForm_Renderer(){
        ...
        'static'=>"\n\t\t".'<div class="fitem {advanced} {emptylabel}"><div class="fitemtitle"><div id="{id}" class="fstaticlabel">{label}<!-- BEGIN required -->{req}<!-- END required -->{advancedimg} {help}</div></div><div class="felement fstatic <!-- BEGIN error --> error<!-- END error -->" aria-labeledby="{id}"><!-- BEGIN error --><span class="error">{error}</span><br /><!-- END error -->{element}</div></div>',
