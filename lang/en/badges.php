...
$string['badgestatus_1'] = 'Not available to users';
$string['badgestatus_2'] = 'Available to users';
$string['badgestatus_3'] = 'Not available to users';
$string['badgestatus_4'] = 'Available to users';
$string['badgestatus_5'] = 'Archived';
...
$string['criteria_descr_short_overall'] = 'Complete <strong>{$a}</strong> of: ';
$string['criteria_descr_short_activity'] = 'Complete <strong>{$a}</strong> of: ';
$string['criteria_descr_short_manual'] = 'Awarded by <strong>{$a}</strong> of: ';
$string['criteria_descr_short_course'] = 'Complete the course ';
$string['criteria_descr_short_courseset'] = 'Complete <strong>{$a}</strong> of: ';
$string['criteria_descr_short_profile'] = 'Complete <strong>{$a}</strong> of: ';
$string['criteria_descr_single_short_activity'] = 'Complete: ';
$string['criteria_descr_single_short_manual'] = 'Awarded by: ';
$string['criteria_descr_single_short_course'] = 'Complete the course ';
$string['criteria_descr_single_short_courseset'] = 'Complete: ';
$string['criteria_descr_single_short_profile'] = 'Complete: ';
$string['criteria_descr_single_activity'] = 'The following activity has to be completed:';
$string['criteria_descr_single_manual'] = 'This badge has to be awarded by a user with the following role:';
$string['criteria_descr_single_course'] = 'Users must complete the course ';
$string['criteria_descr_single_courseset'] = 'The following course has to be completed:';
$string['criteria_descr_single_profile'] = 'The following user profile field has to be completed:';
$string['criteria_descr_overall'] = 'Learners are awarded this badge when they complete <strong>{$a}</strong> of the listed requirements.';
$string['criteria_descr_activity'] = '<strong>{$a}</strong> of the following activities are completed:';
$string['criteria_descr_manual'] = 'This badge has to be awarded by the users with <strong>{$a}</strong> of the following roles:';
$string['criteria_descr_course'] = 'Users must complete the course ';
$string['criteria_descr_courseset'] = '<strong>{$a}</strong> of the following courses have to be completed:';
$string['criteria_descr_profile'] = '<strong>{$a}</strong> of the following user profile fields have to be completed:';
$string['criteria_overall'] = 'This badge is awarded when...';
$string['criteria_activity'] = 'Activity completion';
$string['criteria_activity_help'] = 'Allows a badge to be awarded to users based on the completion of a set of activities within a course.';
$string['criteria_manual'] = 'Manual issue by role';
$string['criteria_manual_help'] = 'Allows a badge to be awarded manually by users who have a particular role within the site or course.';
$string['criteria_social'] = 'Social participation';
$string['criteria_social_help'] = 'Social';
$string['criteria_course'] = 'Course completion';
$string['criteria_course_help'] = 'Allows a badge to be awarded to users who have completed the course. This criterion can have additional parameters such as minimum grade and date of course completion.';
$string['criteria_courseset'] = 'Completing a set of courses';
$string['criteria_courseset_help'] = 'Allows a badge to be awarded to users who have completed a set of courses. Each course can have additional parameters such as minimum grade and date of course completion. ';
$string['criteria_profile'] = 'Profile completion';
$string['criteria_profile_help'] = 'Allows a badge to be awarded to users for completing certain fields in their profile. You can select from default and custom profile fields that are available to users. ';
