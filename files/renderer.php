...
class core_files_renderer extends plugin_renderer_base {
    ...
    private function fm_print_generallayout($fm) {
        ...
        $addfiletext = get_string('addfiletext', 'repository');
        $createfolder = get_string('createfolder', 'repository');
        $downloadallfiles = get_string('downloadallfiles', 'repository');
            ...
            <div class="fp-toolbar">
                <div class="fp-btn-add">
                    <a role="button" title="' . $straddfile . '" href="#">
                        <img src="' . $this->pix_url('a/add_file') . '" alt="' . $addfiletext . '" />
                    </a>
                </div>
                <div class="fp-btn-mkdir">
                    <a role="button" title="' . $strmakedir . '" href="#">
                        <img src="' . $this->pix_url('a/create_folder') . '" alt="' . $createfolder . '" />
                    </a>
                </div>
                <div class="fp-btn-download">
                    <a role="button" title="' . $strdownload . '" href="#">
                        <img src="' . $this->pix_url('a/download_all').'" alt="' . $downloadallfiles . '" />
                    </a>
                </div>
